        ...
        <div class="row">
            <div class="col-12 col-md-5 col-lg-4 col-xl-3">
                ...
                <div class="user">
                    ...
                    <a href="profile.html" class="sidebox__more">View profile</a>
                </div>
                <!-- end user -->
                    ...
                    <div class="post__stats">
                        <div>
                            ...
                            <a class="post__comments" data-toggle="collapse" href="#collapse1" role="button"
                                aria-expanded="false" aria-controls="collapse1"><i class="icon ion-ios-text"></i>
                                <span>0</span></a>
                        </div>
                ...
                <div class="post">
                    ...
                    <div class="post__stats">
                        <div>
                            ...
                            <a class="post__comments" data-toggle="collapse" href="#collapse2" role="button"
                                aria-expanded="true" aria-controls="collapse2"><i class="icon ion-ios-text"></i>
                                <span>2</span></a>
                        </div>
                    ...
                    <div class="collapse show post__collapse" id="collapse2">
                        ...
                        <div class="post__comment">
                            ...
                            <p class="post__comment-text">Many desktop publishing packages and web page editors now use
            ...
            <div class="col-12 col-md-5 col-lg-4 col-xl-3">
                ...
                <!-- sidebox -->
                <div class="sidebox sidebox--desk">
                    <h4 class="sidebox__title">New candidates</h4>
                    <div class="sidebox__content">
                        <div class="sidebox__user">
                            <a href="#" class="sidebox__user-img">
                                <img src="/assets/img/user3.jpg" alt="">
                            ...
                            <div class="sidebox__user-price">$25/hr</div>
                        </div>
                        ...
                        <div class="sidebox__user">
                            ...
                            <div class="sidebox__user-price">$21/hr</div>
                        </div>
                        ...
                        <div class="sidebox__user">
                            ...
                            <div class="sidebox__user-price">$56/hr</div>
                        </div>
                        ...
                        <div class="sidebox__user">
                            ...
                            <div class="sidebox__user-price">$28/hr</div>
                        </div>
                        ...
                        <div class="sidebox__user">
                            ...
                            <div class="sidebox__user-price">$32/hr</div>
                        </div>
                    </div>
                    <a href="#" class="sidebox__more">View more</a>
                </div>
